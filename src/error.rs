...
pub enum Error {
    ...
    /// Starting a git command for a review failed.
    ...
    /// Git produced a diff that cannot be represented as UTF-8.
    #[cfg(feature = "code-tools")]
    ...
    /// `inspect`, `callgraph`, `repomap`, review) failed on caller input: an
